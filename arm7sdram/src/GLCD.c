...
void GLCD_init (void) { 
  ...
  static unsigned char buf[FB_SIZE];
  fb_start = buf;           /* Initialize Frame Buffer            */
...
void GLCD_bitmap (unsigned int x, unsigned int y, unsigned int w, unsigned int h, const unsigned char *bitmap) {
